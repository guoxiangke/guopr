...
<div id="wrap" class="clearfix">
  <header id="header" class="clearfix" role="banner">
    <div id="header-top" class="clearfix">
      ...
      <?php if ($page['language']): ?><!-- / start language region -->
        <div class="language">
          <?php print render($page['language']); ?>
        </div>
       <?php endif; ?> <!-- / end language region -->
       
       <?php if ($page['user_menu']): ?><!-- / start user menu region -->
        <div class="user-menu">
          <?php print render($page['user_menu']); ?>
        </div>
       <?php endif; ?> <!-- / end user menu region -->
  ...
  <?php if ($page['text_resize']): ?><!-- / start text resize region -->
        <div class="text-resize">
          <?php print render($page['text_resize']); ?>
        </div>
       <?php endif; ?> <!-- / end text resize region -->
